...
exports.saveVersusBattleResult = void 0;
var __1 = require("../..");
// Import Util
var common = __importStar(require("../common"));
// Save versus battle result
function saveVersusBattleResult(body, car) {
    return __awaiter(this, void 0, void 0, function () {
        var vsResult, data;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!!(body.retired)) return [3 /*break*/, 2];
                    vsResult = body === null || body === void 0 ? void 0 : body.vsResult;
                    if (!vsResult) return [3 /*break*/, 2];
                    data = {
...
exports.saveVersusBattleResult = saveVersusBattleResult;
